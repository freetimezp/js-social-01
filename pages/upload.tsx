            ...
            >
                <div>
                    ...
                    <div className="border-dashed rounded-xl border-4 border-gray-200 flex flex-col justify-center
                        items-center outline-none mt-10 p-10 cursor-pointer hover:border-red-300
                        hover:bg-gray-100 w-[260px]"
                    >
                        {isLoading ? (
                            <p>
                                Uploading...
                            ...
                            <div>
                                {videoAsset ? (
                                    <div>
                                        <video
                                            src={videoAsset?.url} loop controls
                                    ...
                                    <label className="cursor-pointer">
                                        <div className="flex flex-col items-center justify-center h-full">
                                            <div className="flex flex-col items-center justify-center">
                                                ...
                                                <p className="text-xl font-semobold">
                                                    Upload video
                                                </p>
                                            </div>
                                            ...
                                            <input
                                                type="file" name="upload-video" className="w-0 h-0"
